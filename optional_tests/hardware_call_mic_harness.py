...
This script is intentionally isolated in `optional_tests/` so it can be
removed cleanly without touching runtime app code.
"""
...
def main():
    ...
    parser.add_argument(
        "--report",
        default="optional_tests/hardware_call_mic_report.json",
